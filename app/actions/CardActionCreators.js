...
let CardActionCreators = {
    fetchCards(){
        AppDispatcher.dispatchAsync(KarbanApi.fetchCards(), {
    ...
    addCard(card){
        AppDispatcher.dispatchAsync(KarbanApi.addCard(card), {
    ...
    updateCard(card, draftCard){
        AppDispatcher.dispatchAsync(KarbanApi.updateCard(card, draftCard), {
